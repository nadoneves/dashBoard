var ip = "intranet.faetec.rj.gov.br:3000";
...
function pieAllSystems(dataIni, dataFim) {
  ...
  for (var i = 0; i < array.length; i++) {
      ...
      $('#rowCharts').append('<div class="col-md-6"><div class="panel panel-info"><div class="panel-heading"><h3 class="panel-title">'+array[i]['sistema']+'</h3></div><div class="panel-body"><div id="chart'+array[i]['sistema']+'" style="height: 300px; width: 100%;"></div></div><div class="panel-footer">Quantidade de acessos '+array[i]['qtd']+'</div></div></div>');
